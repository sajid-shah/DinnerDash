...
User.create!(email: 'super@admin.com', fullname: 'super admin', password: '1234567', password_confirmation: '1234567')
User.create!(email: 'admin@admin.com', fullname: 'admin admin', password: '1234567', password_confirmation: '1234567')
User.create!(email: 'customer@customer.com', fullname: 'customer customer', password: '1234567',
             password_confirmation: '1234567', role: 'customer')
User.create!(email: 'customer@again.com', fullname: 'customer again', password: '1234567',
             password_confirmation: '1234567', role: 'customer')
...
Item.create!(title: 'Garlic Fries', description: 'Special Garlic Sauce', price: 300.0, restaurant_id: 3,
             category_ids: [4])
Item.create!(title: 'Sushi', description: 'Chinese Special Dish', price: 2000.0, restaurant_id: 5, category_ids: [5])
Item.create!(title: 'Beef Kabab', description: 'Grilled in Smoke', price: 500.0, restaurant_id: 1, category_ids: [1])
Item.create!(title: 'Prawns Soup', description: 'In Tradition Style', price: 350.0, restaurant_id: 4, category_ids: [5])
...
Item.create!(title: 'Thai Pasta', description: 'Vegetables, Japanese Style', price: 400.0, restaurant_id: 5,
             category_ids: [5])
Item.create!(title: 'Thai Soup', description: 'Egg, Corn, Chicken', price: 250.0, restaurant_id: 5, category_ids: [5])
Item.create!(title: 'Corn Soup', description: 'Corns, Eggs, Spicy', price: 600.0, restaurant_id: 4, category_ids: [3])
